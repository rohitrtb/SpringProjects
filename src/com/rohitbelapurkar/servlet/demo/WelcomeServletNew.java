...
import com.rohitbelapurkar.service.demo.WelcomeService;

/**
 * Servlet implementation class WelcomeServlet
 */
@WebServlet(description = "Demo for servlet", urlPatterns = { "/WelcomeServletNew" })
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Rohit Belapurkar");
